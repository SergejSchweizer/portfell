...
Git status: integrated on `main` at `827eb37`; the workspace-service and
...
copy were removed. The strict Pyright gate now passes with zero diagnostics;
the source-contract QA was fixed to use the canonical `amount` dividend column.
