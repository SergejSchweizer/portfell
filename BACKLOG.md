...
PR: steps 1–3: https://github.com/SergejSchweizer/portfell/pull/401 (schema, bounded reader,
conditional GET, and same-transaction project-command writes); subsequent steps add complete
