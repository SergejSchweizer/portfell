...
PR: steps 1–2: https://github.com/SergejSchweizer/portfell/pull/401 (schema, bounded reader, and
conditional GET); subsequent steps add transactional projection reconciliation.
