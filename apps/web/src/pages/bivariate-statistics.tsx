  ...
  return (
    <Panel title="Bivariate Statistics">
      ...
      <section className="bivariate-statistic" aria-labelledby="pairwise-dependence-title">
        ...
        {activePairwiseMetric === "tail_risk_scatter" ? <TailRiskScatter scatter={tailRiskScatter} /> : activePairwiseMetric === "rolling_stability" ? <BivariateMetricWindow title="Rolling-Correlation" description="Distribution across the selected ISIN pairs." equation="" notation="" dateStart={summary?.date_start} dateEnd={summary?.date_end} primary={activeMetricSummary} primaryLabel="rolling correlation standard deviation" /> : <PairMatrix matrix={activeMatrix} title={activeMatrixTitle} hoveredCell={hoveredMatrixCell} setHoveredCell={setHoveredMatrixCell} />}
      </section>
    </Panel>
  );
}
