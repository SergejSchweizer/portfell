...
- [Guiding Principles](#guiding-principles)
  ...
  - [No single optimizer is universally best](#no-single-optimizer-is-universally-best)
  - [Out-of-sample evidence over in-sample fit](#out-of-sample-evidence-over-in-sample-fit)
  - [Explainability](#explainability)
  - [Reproducibility](#reproducibility)
  - [Decision support, not guaranteed performance](#decision-support-not-guaranteed-performance)
- [Target User Workflows](#target-user-workflows)
  - [Build a new portfolio](#build-a-new-portfolio)
  - [Analyze an existing portfolio](#analyze-an-existing-portfolio)
  - [Monitor a portfolio](#monitor-a-portfolio)
- [Data Requirements](#data-requirements)
  - [Current core data](#current-core-data)
  - [Additional data required for a stronger public product](#additional-data-required-for-a-stronger-public-product)
- [Analysis Layers](#analysis-layers)
- [1. Universe And Eligibility Analysis](#1-universe-and-eligibility-analysis)
- [2. Individual Fund Analysis](#2-individual-fund-analysis)
  - [Return and trend metrics](#return-and-trend-metrics)
  - [Risk metrics](#risk-metrics)
  - [Data-quality diagnostics](#data-quality-diagnostics)
- [3. Income And Distribution Analysis](#3-income-and-distribution-analysis)
- [4. Pairwise And Diversification Analysis](#4-pairwise-and-diversification-analysis)
- [Risk Models](#risk-models)
  - [Required production estimators](#required-production-estimators)
  - [Diagnostics](#diagnostics)
- [Portfolio Construction Methods](#portfolio-construction-methods)
  - [1. Equal Weight](#1-equal-weight)
  - [2. Inverse Volatility](#2-inverse-volatility)
  - [3. Constrained Minimum Variance](#3-constrained-minimum-variance)
  - [4. Equal Risk Contribution](#4-equal-risk-contribution)
  - [5. True Hierarchical Risk Parity](#5-true-hierarchical-risk-parity)
  - [6. Maximum Diversification](#6-maximum-diversification)
  - [7. Minimum CVaR](#7-minimum-cvar)
  - [8. Maximum Sharpe As A Comparison Method](#8-maximum-sharpe-as-a-comparison-method)
- [Portfolio Constraints](#portfolio-constraints)
- [Portfolio Profiles](#portfolio-profiles)
  - [Defensive](#defensive)
  - [Balanced](#balanced)
  - [Income](#income)
  - [Growth](#growth)
- [Ensemble Portfolio](#ensemble-portfolio)
- [Validation Framework](#validation-framework)
- [Walk-Forward Backtesting](#walk-forward-backtesting)
- [Rebalancing Simulation](#rebalancing-simulation)
- [Return Semantics](#return-semantics)
- [Costs And Execution Realism](#costs-and-execution-realism)
- [Stress And Robustness Analysis](#stress-and-robustness-analysis)
- [Model Comparison And Recommendation](#model-comparison-and-recommendation)
- [Current Technical Prerequisites](#current-technical-prerequisites)
- [Public Access Strategy](#public-access-strategy)
  - [Stage 1: Open-source local application](#stage-1-open-source-local-application)
  - [Stage 2: Hosted user interface with bring-your-own-key](#stage-2-hosted-user-interface-with-bring-your-own-key)
  - [Stage 3: Managed service](#stage-3-managed-service)
- [Initial Hosted Architecture](#initial-hosted-architecture)
  - [Initial topology](#initial-topology)
  - [Responsibilities](#responsibilities)
  - [Initial data flow](#initial-data-flow)
  - [Initial storage model](#initial-storage-model)
  - [Minimal repository direction](#minimal-repository-direction)
  - [Minimal API surface](#minimal-api-surface)
  - [Initial UI scope](#initial-ui-scope)
  - [Minimal Docker Compose direction](#minimal-docker-compose-direction)
  - [Initial analysis scope](#initial-analysis-scope)
  - [Growth path](#growth-path)
- [Proposed Module Direction](#proposed-module-direction)
- [Implementation Priorities](#implementation-priorities)
  - [P0: Correctness and production foundations](#p0-correctness-and-production-foundations)
  - [P1: Robust portfolio construction](#p1-robust-portfolio-construction)
  - [P2: Income specialization](#p2-income-specialization)
  - [P3: Validation and recommendation](#p3-validation-and-recommendation)
  - [P4: User product](#p4-user-product)
- [Initial Production Definition Of Done](#initial-production-definition-of-done)
- [Initial Recommended Default](#initial-recommended-default)
