...
def compute_multivariate(
    *,
    ...
    daily_return_rows: Sequence[Mapping[str, Any]] | None = None,
    ...
    # Prefer the immutable daily return observations generated by the matching
    # Univariate run.  Rebuilding from quotes is retained only for legacy runs
    # that have no persisted daily-return artifact.
    returns = (
