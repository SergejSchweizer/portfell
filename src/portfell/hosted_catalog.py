...
from portfell.hosted_status_event_retention_schema import HOSTED_STATUS_EVENT_RETENTION_SCHEMA_SQL
...
HOSTED_TABLES: tuple[HostedTable, ...] = (
    ...
    HostedTable(
        "portfell_app.project_workflow_projections",
        True,
        False,
...
MIGRATIONS: tuple[HostedMigration, ...] = (
    ...
    HostedMigration(24, "hosted_status_event_retention", HOSTED_STATUS_EVENT_RETENTION_SCHEMA_SQL),
)
