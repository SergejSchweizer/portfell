...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        workflow_data = SharedMarketResearchData(SharedMarketDataStore(Path(root)))
        workflow_repositories = PostgresHostedRepositoryBundle.from_connection(bootstrap_connection)
        workflow_projector = PostgresProjectWorkflowProjector(
            PostgresWorkflowReader(
                ...
                quote_period=workflow_data.quote_period,
            ),
