...
For the original detailed PR264-PR275 task checklists, use this file's prior revision preserved in Git history together with the active `BACKLOG.md` summaries and the amendment. The amendment is mandatory acceptance for its named PRs and PR276.